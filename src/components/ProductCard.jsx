...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="flex flex-col justify-between min-h-[340px] bg-white rounded-xl shadow-md p-4">
      ...
      <button className="mt-4 w-full flex items-center justify-center gap-2 bg-themeColor text-bgColor py-2 rounded hover:bg-opacity-90 transition">
        <i className="ri-flashlight-line text-lg"></i>
        Buy Now
      </button>
      <button className="mt-2 w-full flex items-center justify-center gap-2 border border-themeColor text-themeColor py-2 rounded hover:bg-themeColor hover:text-bgColor transition">
